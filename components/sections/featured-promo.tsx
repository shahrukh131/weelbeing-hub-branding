...
const FEATURED_PROMOS: Promo[] = [
  {
    ...
    desc: "Full-body checkup for 4 family members with a free specialist consultation, bundled at one price with a set validity period.",
    perks: ["4 members", "Free consult", "One price"],
    price: "৳1,499",
    old: "৳2,500",
    cta: "Book package",
  },
  ...
  },
  {
    badge: "Health card",
    off: "ALL TIERS",
    title: "One card, every partner hospital",
    desc: "Consultation benefits and discounted tests across the network, with every benefit you use tracked in your wallet.",
    perks: ["Network-wide", "Benefits tracked", "Set validity"],
    price: "View tiers",
    cta: "Explore tiers",
  },
]
